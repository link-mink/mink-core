...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_gdt_2eproto = {
  false, false, 3055, descriptor_table_protodef_gdt_2eproto, "gdt.proto", 
