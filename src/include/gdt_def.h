...
namespace asn1 {
    ...
    public:
        ...
        static const int _pt_sccp_called_party = 302;
        static const int _pt_sccp_calling_party = 303;
        static const int _pt_sccp_protocol_class = 304;
        static const int _pt_sccp_segmenting_reassembling = 305;
        static const int _pt_sccp_receive_sequence_number = 306;
        static const int _pt_sccp_sequencing_segmenting = 307;
        static const int _pt_sccp_credit = 308;
        static const int _pt_sccp_release_cause = 309;
        static const int _pt_sccp_return_cause = 310;
        static const int _pt_sccp_reset_cause = 311;
        static const int _pt_sccp_error_cause = 312;
        static const int _pt_sccp_refusal_cause = 313;
        static const int _pt_sccp_data = 314;
        static const int _pt_sccp_segmentation = 315;
        static const int _pt_sccp_hop_counter = 316;
        static const int _pt_sccp_importance = 317;
        static const int _pt_sccp_long_data = 318;
        static const int _pt_sccp_called_pa_routing_indicator = 310;
        static const int _pt_sccp_called_pa_global_title_indicator = 320;
        static const int _pt_sccp_called_pa_ssn_indicator = 321;
        static const int _pt_sccp_called_pa_point_code_indicator = 322;
        static const int _pt_sccp_called_pa_point_code_number = 323;
        static const int _pt_sccp_called_pa_subsystem_number = 324;
        static const int _pt_sccp_called_pa_gt_numbering_plan = 325;
        static const int _pt_sccp_called_pa_gt_encoding_scheme = 326;
        static const int _pt_sccp_called_pa_gt_nature_of_address = 327;
        static const int _pt_sccp_called_pa_gt_address = 328;
        static const int _pt_sccp_called_pa_gt_translation_type = 329;
        static const int _pt_sccp_calling_pa_routing_indicator = 330;
        static const int _pt_sccp_calling_pa_global_title_indicator = 331;
        static const int _pt_sccp_calling_pa_ssn_indicator = 332;
        static const int _pt_sccp_calling_pa_point_code_indicator = 333;
        static const int _pt_sccp_calling_pa_point_code_number = 334;
        static const int _pt_sccp_calling_pa_subsystem_number = 335;
        static const int _pt_sccp_calling_pa_gt_numbering_plan = 336;
        static const int _pt_sccp_calling_pa_gt_encoding_scheme = 337;
        static const int _pt_sccp_calling_pa_gt_nature_of_address = 338;
        static const int _pt_sccp_calling_pa_gt_address = 339;
        static const int _pt_sccp_calling_pa_gt_translation_type = 340;
        static const int _pt_sccp_message_type = 341;
